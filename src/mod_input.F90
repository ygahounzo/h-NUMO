...
module mod_input
   ...
   public :: namelist_input, &
        ...
        adjust_H_vertical_sum, is_mlswe_linear, botfr, mass_exact, bcl_flux, mlswe_bc_strong, dg_integ_exact, dump_data, flux_type, method_consistency
 ...
 contains
   ...
   subroutine mod_input_create(irank)
     ...
     namelist /input/ dt, &
         ...
         mass_exact, bcl_flux, mlswe_bc_strong, dg_integ_exact, dump_data, flux_type, method_consistency
