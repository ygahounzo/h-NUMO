module mod_rk_mlswe
    ...
    use mod_laplacian_quad, only: create_laplacian_mlswe_v5

    implicit none

    public :: ti_barotropic_rk_mlswe2, ti_barotropic_ssprk_mlswe, ti_barotropic_rk_mlswe3, ti_barotropic_ssprk_mlswe2
    ...
    subroutine ti_barotropic_rk_mlswe3(one_plus_eta_out,one_plus_eta_edge_2_ave,uvb_ave, ope_ave, ope2_ave,&
        ...
        ! Compute the gradient of uprime and vrime and multiple by dpprime. These values will be used in the LDG method for the Laplacian term
        call btp_laplacian_terms(grad_uvdp,grad_uvdp_face,qprime_df,qb0_df, qprime(1,:,:))
        ...
        ! Communication of the gradient values
        call create_communicator_quad(grad_uvdp_face,4)
    ...
    subroutine ti_barotropic_ssprk_mlswe(one_plus_eta_out,one_plus_eta_edge_2_ave,uvb_ave, ope_ave, ope2_ave,&
        ...
        ! Compute grad uprime and vprime and multiply them by dpprime for their use in the viscosity terms 
        ...
        do mstep = 1, N_btp
            ...
            do ik=1,kstages
                ...
                !call create_rhs_btp_momentum_new2(rhs_mom,Quu,Qvv,Quv,H,qb,H_face,Qu_face,Qv_face,tau_bot,btp_mass_flux, flux_edge, grad_uvdp,grad_uvdp_face, qb_face)
                ...
                if(mstep == N_btp) then 
                    ...
                    call btp_laplacian_terms_v1(grad_uvdp,qprime_df,qb_df, qprime(1,:,:))
                    call btp_evaluate_mom_dp_graduvdp_face(qb_face, grad_uvdp_face, qb, grad_uvdp)
    ...
    subroutine ti_barotropic_ssprk_mlswe2(one_plus_eta_out,one_plus_eta_edge_2_ave,uvb_ave, ope_ave, ope2_ave,&
        H_ave, Qu_ave, Qv_ave, Quv_ave, btp_mass_flux_ave, ope_ave_df, uvb_face_ave, &
        ope_face_ave, btp_mass_flux_face_ave, H_face_ave, &
        Qu_face_ave, Qv_face_ave, Quv_face_ave, tau_wind_ave, tau_bot_ave, qb,qb_face,&
        qb_df,qprime,qprime_face, qprime_df, flag_pred, uvb_df_ave)
    ...
    end subroutine ti_barotropic_ssprk_mlswe2
