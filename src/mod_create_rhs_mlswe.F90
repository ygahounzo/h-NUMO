...
contains
    ...
    ! w-momentum row (mass,u,v,w) and the full 3D Coriolis cross-product/pressure
    ...
    subroutine create_rhs_dynamics_volume_bcl_sphere(G, inp, b, btp, bcl, init, tsp, rhs, qprime_df, q_df)
        ...
        !$acc           cfx, cfy, cfz, u, v, w, wq, hi, dhdx, dhdy, dhdz,              &
        ...
        do Iq = 1, npoin_q_l
            ...
            ! ---------------------------------------------------------------
            !  3D Coriolis (precomputed in wind_stress_coriolis).
            ! ---------------------------------------------------------------
