...
module mod_rhs_btp
    ...
    public :: create_rhs_btp, create_rhs_btp2, create_rhs_btp3, create_rhs_btp4, &
...
contains
    ...
    subroutine create_rhs_btp2(rhs,qb_df,qprime_df, stage)
    ...
    subroutine create_rhs_btp4(rhs,qb_df,qprime, stage)
        ...
        call create_rhs_btp_volume_qdf4(rhs, qb_df, qprime)
    ...
    end subroutine create_rhs_btp4
    ...
    subroutine create_rhs_btp_volume_qdf4(rhs, qb_df, qprime)
